...
- For my current setup, heater Ch1 = 50/30mm guidescope, Ch2 = 80mm refractor; these are gainPID[0] & [1] = 2 & 1
*/
float gainPID[] {2, 1, 1, 1};                   // gain factor for PID Kp/i/d for channels 1-4 (using base Kp, Ki, Kd values of 10, 10, 0)
