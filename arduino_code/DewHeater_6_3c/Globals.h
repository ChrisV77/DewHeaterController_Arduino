...
const int manualPowerRange[maxChannels]     = {0,100,10,10};   // default 10%
const int aAmbMaxPwrRange[maxChannels]      = {0,100,40,10};   // default 30%
...
const int   comDelay = 50;                      // delay for PC coms - had 200ms, trying shorter - 150, 100, 50. %0 seems okay
